...
import logoDark from '../../assets/img/logo/logonew2.png';
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === 'dark' ? (
          <img src={logoLight} alt="dashtar" height="82" className="pl-6 logoStyle" />
        ) : (
          <img src={logoDark} alt="dashtar" height="82" className="pl-6 logoStyle" />
        )}
      </a>
      <ul className="mt-8">
        {sidebar.map((route) => (
