          ...
          <div className="flex flex-col lg:flex-row md:flex-row w-full overflow-hidden">
            ...
            <div className="w-full flex flex-col p-5 md:p-8 text-left">
              <div className="mb-5 block ">
                ...
                <p className="uppercase font-serif font-medium text-gray-400 text-sm">
                  SKU :{' '}
              ...
              <div className="mb-3">
                ...
                <span className="text-sm text-gray-400 font-medium pl-4">
                  Quantity: {data.quantity}
                </span>
              </div>
              <p className="text-sm leading-6 text-gray-400 md:leading-7">
                {data.description}
              </p>
